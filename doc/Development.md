# Development and Testing Guide <br/> Pip.Services ElasticSearch for .NET
...
```bash
nuget pack pip-services3-elasticsearch-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.ElasticSearch.XXX.nupkg -Source https://www.nuget.org/api/v2/package
```
